...
export const BlogCard = ({
  ...
  return (
    <Link to={`/blog/${id}`}>
   <div className="max-w-xl mx-auto bg-white rounded-lg shadow-md hover:shadow-lg transform transition duration-200 ease-in-out hover:scale-102 overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="text-xs text-gray-500">
          {`${Math.ceil(content.length / 1000)} minute${Math.ceil(content.length / 1000) !== 1 ? 's' : ''} read`}
        </div>
      </div>
    </div>
    </Link>
